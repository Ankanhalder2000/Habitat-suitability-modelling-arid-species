...
Sources of uncertainty in the habitat suitability model were identified and evaluated qualitatively.
...
Despite these limitations, uncertainty is constrained by the deterministic nature of the modelling workflow and consistent preprocessing across layers.



Future model versions will incorporate quantitative uncertainty estimation, including:
